...
<script>
import StatItemPlaceholder from "./DashboardSkeletonAnimation/StatItemPlaceholder.vue";
...
<style lang="scss">
@keyframes dashboardSkeletonAppearance {
    from {
        opacity: 0;
    }
    to {
...
.dashboardSkeleton {
    animation: dashboardSkeletonAppearance 400ms ease-in-out;
    opacity: 1;
