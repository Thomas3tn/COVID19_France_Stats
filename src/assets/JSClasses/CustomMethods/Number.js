...
export default class NumberCustomMethods {
    ...
    static getPercentageOfPartFromTotal(part, total) {
    ...
    static roundFloatNumber(number) {
        ...
        if (typeof number !== "number") {
            console.error("The roundFloatNumber method first parameter has to be a number.");
            return;
        }
    ...
    static convertNumberToStatString(number, addSign = false) {
    ...
    static addNumberPointSeparator(number) {
