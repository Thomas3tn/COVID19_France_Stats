...
export default {
    setWorldLocationEvolutionDatas: {
                            ...
                            .then(response => {
                                ...
                                if (requestParameters.locationType === "countriesList") {
                                    ...
                                    for (const [key, value] of Object.entries(response)) {
                                        ...
                                        const formattedCountryName = datasCalculator.textFunctionalities.removeCountryNameSpecialCharacters(key);

                                        if (typeof locationEvolutionDatas.datas[formattedCountryName] === "undefined") {
                                            locationEvolutionDatas.datas[formattedCountryName] = {};
                                        }
                                        ...
                                        locationEvolutionDatas.datas[formattedCountryName][requestParameters.urlStatusKeysValues[currentStatusIndex].split("=")[1]] = value.All.dates;
